...
public class ConfigRemoteServiceImpl implements ConfigRemoteService {
    ...
    public ConfigRemoteServiceImpl() {
        ...
        CommunicationRegistry.regist(ConfigEventType.findWideTable, this);
        CommunicationRegistry.regist(ConfigEventType.findLoadRoute, this);
    }
    ...
    @Override
    public List<WideTable> onFindWideTable(FindWideTableEvent event) {
        Assert.notNull(event);
        Assert.notNull(event.getTableId());
        Assert.notNull(event.getTargetId());
        return wideTableService.listByTargetIdAndTableId(event.getTargetId(),event.getTableId());
    }

    @Override
    public List<LoadRoute> onFindLoadRoute(FindLoadRouteEvent event) {
        Assert.notNull(event);
        return loadRouteService.listByCondition(new HashMap(0));
    }
    ...
    public void setLoadRouteService(LoadRouteService loadRouteService) {
        this.loadRouteService = loadRouteService;
    }
