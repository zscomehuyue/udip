...
public class DataMediaPairServiceImpl implements DataMediaPairService {
    ...
    public DataMediaPair findById(Long dataMediaPairId) {
        ...
        DataMediaPair dataMediaPair = dataMediaPairs.get(0);
        Map<String,Object> loadRoutCondtion = new HashMap<>();
        loadRoutCondtion.put("pipelineId",dataMediaPair.getPipelineId());
        loadRoutCondtion.put("tableId",dataMediaPair.getTarget().getId());
        List<LoadRoute> loadRouteList = loadRouteService.listByCondition(loadRoutCondtion);
        dataMediaPair.setLoadRouteList(loadRouteList);
