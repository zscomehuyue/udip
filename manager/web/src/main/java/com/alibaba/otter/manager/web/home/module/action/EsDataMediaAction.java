...
public class EsDataMediaAction extends AbstractAction {
     ...
     * @throws Exception
     */
    public void doAdd(@FormGroup("esDataMediaInfo") Group dataMediaInfo,
                      @FormField(name = "formDataMediaError", group = "esDataMediaInfo") CustomErrors err, Navigator nav)
                                                                                                                       throws Exception {
        ...
        if (dataMediaSource.getType().isEs()) {
            dataMedia.setSource((IndexMediaSource) dataMediaSource);
        }
        ...
        nav.redirectTo(WebConstant.ES_DATA_MEDIA_LIST_LINK);
    }
    ...
    public void doDelete(@Param("dataMediaId") Long dataMediaId, @Param("pageIndex") int pageIndex,
        ...
        nav.redirectToLocation("esDataMediaList.htm?pageIndex=" + pageIndex + "&searchKey=" + urlEncode(searchKey));
    }

    public void doEdit(@FormGroup("esDataMediaInfo") Group dataMediaInfo, @Param("pageIndex") int pageIndex,
