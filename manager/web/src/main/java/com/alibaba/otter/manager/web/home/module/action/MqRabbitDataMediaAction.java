...
public class MqRabbitDataMediaAction extends AbstractAction {
     ...
     * @throws Exception
     */
    public void doAdd(@FormGroup("mqRabbitDataMediaInfo") Group dataMediaInfo,
                      @FormField(name = "formDataMediaError", group = "mqRabbitDataMediaInfo") CustomErrors err, Navigator nav)
                                                                                                                       throws Exception {

        DataMedia dataMedia = new DataMedia();
        dataMediaInfo.setProperties(dataMedia);
        dataMedia.setName(dataMedia.getNamespace());
        ...
        nav.redirectTo(WebConstant.MQ_RABBITDATA_MEDIA_LIST_LINK);
    }
    ...
    public void doDelete(@Param("dataMediaId") Long dataMediaId, @Param("pageIndex") int pageIndex,
        ...
        nav.redirectToLocation("mqRabbitDataMediaList.htm?pageIndex=" + pageIndex + "&searchKey=" + urlEncode(searchKey));
    }

    public void doEdit(@FormGroup("mqRabbitDataMediaInfo") Group dataMediaInfo, @Param("pageIndex") int pageIndex,
