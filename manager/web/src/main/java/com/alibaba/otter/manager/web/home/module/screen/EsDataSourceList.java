...
import com.alibaba.otter.manager.web.common.model.SeniorEsDataMediaSource;
...
public class EsDataSourceList {
    ...
    public void execute(@Param("pageIndex") int pageIndex, @Param("searchKey") String searchKey, Context context)
        ...
        typeLs.add(DataMediaType.ES);
        condition.put("DataMediaType", typeLs);


        List<DataMediaSource> dataMediaSources = dataMediaSourceService.listByCondition(condition);
        List<SeniorEsDataMediaSource> seniorDataMediaSources = new ArrayList<SeniorEsDataMediaSource>();
        for (DataMediaSource dataMediaSource : dataMediaSources) {

            SeniorEsDataMediaSource seniorDataMediaSource = new SeniorEsDataMediaSource();
            ...
            if (dataMediaSource instanceof IndexMediaSource) {
                seniorDataMediaSource.setClusterNodes(((IndexMediaSource) dataMediaSource).getClusterNodes());
            }
