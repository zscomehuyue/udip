...
public interface WebConstant {
    ...
    String ES_DATA_MEDIA_LIST_LINK             = "esDataMediaListLink";

    String MQ_RABBITDATA_MEDIA_LIST_LINK             = "mqRabbitDataMediaListLink";
    ...
    String ES_DATA_MEDIA_SOURCE_LIST_LINK   = "esDataMediaSourceListLink";

    String MQ_RABBIT_DATA_MEDIA_SOURCE_LIST_LINK   = "mqRabbitDataMediaSourceListLink";
    ...
    String WIDE_TABLE_LIST_LINK = "wideTableListLink";


    String Check_Table_Rel_LINK             = "checkTableRelLink";
