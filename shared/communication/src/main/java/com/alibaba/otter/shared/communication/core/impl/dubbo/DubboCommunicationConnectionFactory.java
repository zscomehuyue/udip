...
public class DubboCommunicationConnectionFactory implements CommunicationConnectionFactory {
    ...
    private final String                       DUBBO_SERVICE_URL = "dubbo://{0}:{1}/endpoint?client=netty&codec=dubbo&serialization=java&lazy=true&iothreads=4&threads=50&connections=30&acceptEvent.timeout=90000";
