package com.hwl.otter.clazz.mapping.cache;
...
public class RedisCacheManager extends AbstractCacheManager {
    ...
    /**
     * Construct a {@link org.springframework.data.redis.cache.RedisCacheManager}.
     *
    ...
    /**
     * Construct a static {@link org.springframework.data.redis.cache.RedisCacheManager}, managing caches for the specified cache names only.
     *
     * @param redisOperations
     * @param cacheNames
     * @since 1.2
    ...
    /**
     * If set to {@code true} {@link org.springframework.data.redis.cache.RedisCacheManager} will try to retrieve cache names from redis server using
