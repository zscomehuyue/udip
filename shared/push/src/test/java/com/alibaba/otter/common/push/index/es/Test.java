...
//        System.out.println(OffsetDateTime.now().toEpochSecond());
        String url = "jdbc:mysql://192.168.1.107:3306/changzhou_xxgl";
        System.out.println(FieldHelper.CITY_CODE_CACHE.get(url));
//        System.out.println("size="+FieldHelper.CITY_CODE_CACHE.size());
//        FieldHelper.CITY_CODE_CACHE.forEach((k,v)->{
//            System.err.println("put(\""+k+"\",\""+v+"\");");
//        });
    }
