...
public enum DataMediaType {
    ...
    public boolean isMq() {
        return this.equals(DataMediaType.RABBIT) || this.equals(DataMediaType.KAFKA);
    }

    public boolean isIndex() {
        return this.equals(DataMediaType.ES) || this.equals(DataMediaType.SOLR);
    }
    ...
    public boolean isRabbit() {
        return this.equals(DataMediaType.RABBIT);
    }

    public boolean isEs() {
        return this.equals(DataMediaType.ES);
    }
