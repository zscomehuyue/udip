...
public class SnowflakeIdUtils {
    ...
    private static final Logger log = LoggerFactory.getLogger(SnowflakeIdUtils.class);
     ...
     * @return id
     */
    public synchronized long nextId(boolean fastError) {
