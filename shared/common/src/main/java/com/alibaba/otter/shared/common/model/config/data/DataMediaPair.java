...
public class DataMediaPair implements Serializable {
    ...
    private List<LoadRoute> loadRouteList;
    ...
    public List<LoadRoute> getLoadRouteList() {
        return loadRouteList;
    }

    public void setLoadRouteList(List<LoadRoute> loadRouteList) {
        this.loadRouteList = loadRouteList;
    }
