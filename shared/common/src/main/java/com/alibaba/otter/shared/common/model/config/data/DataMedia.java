...
public class DataMedia<Source extends DataMediaSource> implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DataMedia<?> dataMedia = (DataMedia<?>) o;

        if (id != null ? !id.equals(dataMedia.id) : dataMedia.id != null) return false;
        if (namespace != null ? !namespace.equals(dataMedia.namespace) : dataMedia.namespace != null) return false;
        return name != null ? name.equals(dataMedia.name) : dataMedia.name == null;
    }
