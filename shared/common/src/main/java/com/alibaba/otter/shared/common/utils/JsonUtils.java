...
public class JsonUtils {
    ...
    public static String marshalToString(Object obj, boolean format) {
        return JSON.toJSONString(obj, format); // 默认为UTF-8
    }
    ...
    public static String marshalToStringExcludeTransient(Object obj) {
        // 获取忽略字段
        Class<?> clazz = obj.getClass();
        Field[] fields = clazz.getDeclaredFields();
        List<String> transientFileds = new ArrayList<String>();
