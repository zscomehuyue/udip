...
public enum StageType {
    ...
    SELECT, EXTRACT, TRANSFORM, LOAD, INDEXLOAD, MQLOAD;
     ...
     * transform和load一定会同时出现
     */
    public boolean isIndexLoad() {
        return this.equals(StageType.INDEXLOAD);
    }

    /**
     * transform和load一定会同时出现
     */
    public boolean isMqLoad() {
        return this.equals(StageType.MQLOAD);
    }
}
