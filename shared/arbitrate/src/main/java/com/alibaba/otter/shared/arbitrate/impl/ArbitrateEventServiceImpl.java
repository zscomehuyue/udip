...
public class ArbitrateEventServiceImpl implements ArbitrateEventService {
    ...
    private MqLoadArbitrateEvent mqLoadEvent;
    private IndexLoadArbitrateEvent indexLoadEvent;
    ...
    @Override
    public MqLoadArbitrateEvent mqLoadEvent() {
        return mqLoadEvent;
    }

    @Override
    public IndexLoadArbitrateEvent indexLoadEvent() {
        return indexLoadEvent;
    }
    ...
    public void setMqLoadEvent(MqLoadArbitrateEvent mqLoadEvent) {
        this.mqLoadEvent = mqLoadEvent;
    }

    public void setIndexLoadEvent(IndexLoadArbitrateEvent indexLoadEvent) {
        this.indexLoadEvent = indexLoadEvent;
    }
}
