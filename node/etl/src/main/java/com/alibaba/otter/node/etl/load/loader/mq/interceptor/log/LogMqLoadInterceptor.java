package com.alibaba.otter.node.etl.load.loader.mq.interceptor.log;
...
public class LogMqLoadInterceptor extends AbstractLoadInterceptor<MqLoadContext, EventData> {
    private static final Logger logger = LoggerFactory.getLogger(LogMqLoadInterceptor.class);
