...
public class OtterLoaderFactory {
    ...
    private AbstractDataBatchLoader         dataBatchLoader;
...
//        if (!(indexSize == 0 && indexCount == 0)) {
//            ThroughputStat indexThroughputStat = new ThroughputStat();
//            indexThroughputStat.setType(ThroughputType.INDEX);
//            indexThroughputStat.setPipelineId(identity.getPipelineId());
//            indexThroughputStat.setNumber(indexCount);
//            indexThroughputStat.setSize(indexSize);
//            indexThroughputStat.setStartTime(new Date(throughput.getStartTime()));
//            indexThroughputStat.setEndTime(endTime);
//            throughputStats.add(indexThroughputStat);
//        }
    ...
    public void setDataBatchLoader(AbstractDataBatchLoader dataBatchLoader) {
