...
mvn install:install-file -DgroupId=com.oracle -DartifactId=ojdbc14 -Dversion=10.2.0.3.0-local -Dpackaging=jar -DpomFile=ojdbc14_10.2.0.3.0-local.pom -Dfile=ojdbc14_10.2.0.3.0-local.jar
